export const projects = [
  {
    ...
    details: {
      description: "Socratic is an educational platform that leverages AI models running on Groq hardware and Firebase services to provide real-time tutoring assistance. It helps students get instant answers, explanations, and messaging with human tutors when needed.",
      key_features: [
